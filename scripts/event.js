...
class Event extends React.Component {
	...
	render() {
		...
		return (
			<div className="event">
				<a href={`https://github.com/${login}`} onClick={this.trackLink.bind(this)} target="_blank">
					<img className="event-image" src={`${avatar}?s=80`} alt={login} width="40" height="40" />
				</a>
				<div className="event-body">
					<p className="event-text">
						<a className="event-link" href={`https://github.com/${login}`} onClick={this.trackLink.bind(this)} target="_blank">
							{login}
						</a>
						{message}
					</p>
