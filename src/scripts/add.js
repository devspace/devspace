...
class Add extends React.Component {
	...
	renderContent() {
		if (this.props.isAddInitialContent) {
			return <AddOptions setSelectedOption={this.setSelectedOptio} toggleAddModal={this.props.toggleAddModal} toggleAddInitialContent={this.props.toggleAddInitialContent} />
		}
		else {
